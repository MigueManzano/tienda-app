...
<body id="container-page-index">
    ...
    <div class="jumbotron" id="jumbotron-index">
      <h1><span class="tittles-pages-logo">Cristales Biselados</span> <small style="color: #fff;">Progreso</small></h1>
      <p>
          Bienvenido a nuestra tienda en línea, aquí encontrará una gran variedad de cristales y láminas para el hogar.
      </p>
    </div>
            ...
            <div class="row">
                <div class="col-xs-12 col-sm-6 text-center">
                   <article style="margin-top:20%;">
                        ...
                        <h3>Regístrate</h3>
                        <p>Regístrese y hágase cliente de <span class="tittles-pages-logo">Cristales Biselados</span> para recibir las mejores ofertas y descuentos especiales de nuestros productos.</p>
                        <p><a href="registration.php" class="btn btn-info btn-block">Regístrarse</a></p>   
                   </article>
                </div>
    ...
    <section id="distribuidores-index">
        <div class="container">
            ...
            <div class="col-xs-12">
                <div class="page-header">
                  <h1>Nuestra <small style="color: #333;">Galería</small></h1>
                </div>
                <br><br>
